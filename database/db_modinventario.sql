...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 20-01-2018 a las 19:24:00
...
CREATE TABLE `productos` (
  ...
  `iva_pro` tinyint(1) NOT NULL COMMENT '1=Si; 0=No',
  `costo_pro` decimal(6,0) NOT NULL,
  `pvp_pro` decimal(6,0) NOT NULL,
  `estado_pro` tinyint(1) NOT NULL DEFAULT '1' COMMENT '1=Activo; 0=Inactivo	'
...
(1, 'pro100', 'aceite', 'aceitesdfghgfd', 1, '10', '15', 1),
(2, 'sdfg', 'sdfg', 'sdfg', 1, '34', '56', 2),
(3, '2454', 'atunfggfdfghjhgfd333', 'atunndndnfghjsdd', 1, '23', '23', 1),
(4, 'sdf', 'sdf', 'sdf', 1, '345', '34', 1);
...
(3, '1003628615', 1, 'Edgar Quezada', '2018-01-17', 'Loja', 'Ibarra', '0978828827', 'A', 'edgar10_09@hotmail.com', '$2y$10$MOVtYu/Nnqm8pi864PTxi.PoEtwReesx/oyeFAzFf0Con/NLIYRMW', 'JmlhreRq35NgfpNmvEIFIUeO3i3eHuswiB02zeSf2XQ6efvzrFkDlMUP7w2a', '2018-01-17 18:49:15', '2018-01-17 18:49:15'),
...
(5, 'ssdf', 1, 'sdxcv', '2018-01-17', 'df', 'sdf', 'sdf', 'A', 'edgar@hotmail.com', '$2y$10$cWTWxcAnlUvEJNVvm3mzSeUYnlksH9CbNev0pzyelweZYOliCmqpW', NULL, '2018-01-18 01:45:20', '2018-01-18 01:45:20');
