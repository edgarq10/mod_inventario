            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  Administrador - 
                  <span class="fa fa-user">Edgar Quezada</span>
                </a>
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="almacen/articulo"><i class="fa fa-circle-o"></i> Administracion Usuarios</a></li>
                <li><a href="almacen/categoria"><i class="fa fa-circle-o"></i> Administracion Bodegueros</a></li>
                <li><a href="almacen/categoria"><i class="fa fa-circle-o"></i> Administracion Productos</a></li>
